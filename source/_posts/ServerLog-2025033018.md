...
```sh
# 添加启动项
easy_daemon add -n Pingap -p /root/App/Pingap/pingap -a -c -a /root/App/Pingap/conf -a --autorestart -a --admin=<USER>:<PASSWD>@127.0.0.1:3000 -a --log=/root/App/Pingap/pingap.log -o ""
# 下次就只需要
